...
public class RoomObject {
    ...
    public static final By secondOptionRoom = By.xpath("//android.widget.FrameLayout[@resource-id=\"com.booking:id/sr_fragment_container\"]//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[not(./android.widget.FrameLayout)][position() = 2]");
