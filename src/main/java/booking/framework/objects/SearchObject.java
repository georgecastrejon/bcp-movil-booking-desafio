...
public class SearchObject {
    ...
    public static final By btnDestino = By.xpath("//android.widget.LinearLayout[@resource-id=\"com.booking:id/facet_search_box_accommodation_destination\"]");
    ...
    public static final By btnCalendario = By.xpath("//android.widget.LinearLayout[@resource-id=\"com.booking:id/facet_search_box_accommodation_dates\"]");
}